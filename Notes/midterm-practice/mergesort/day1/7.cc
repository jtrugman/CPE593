...
mergesortCompute(int[] array, int[] tempArray, leftStart, rightEnd) {
...
mergeHalves(int[] array, int[] tempArray, int leftStart, int rightEnd) {
    ...
    System.arraycopy(array, left, tempArray, leftEnd - left - 1);
    System.arraycopy(array, right, tempArray, rightEnd - right - 1);
